...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img src="/avatar/{{Auth::user()->image}}"></img>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('suggest.index')}}">List Suggests</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('promotion.index')}}">List Promotions</a></li>
                    </ul>
                    <ul class="sub">
                        <li><a href="{{route('promotion.create')}}">Add Promotions</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
